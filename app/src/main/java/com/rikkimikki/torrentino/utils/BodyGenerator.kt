...
fun getFilmsFromCategoryBody(category: Category,offset:Int): RequestBody{
    return generateBody(
        "MovieDesktopListPage",
        String.format("{\"slug\": \"\", \"platform\": \"DESKTOP\", \"regionId\": 213, \"withUserData\": \"false\", \"supportedFilterTypes\": [\"BOOLEAN\", \"SINGLE_SELECT\"], \"filters\": {\"booleanFilterValues\": [], \"intRangeFilterValues\": [], \"singleSelectFilterValues\": [{\"filterId\": \"genre\", \"value\": \"%s\"}], \"multiSelectFilterValues\": [], \"realRangeFilterValues\": []}, \"singleSelectFiltersLimit\": 250, \"singleSelectFiltersOffset\": 0, \"moviesLimit\": 50, \"moviesOffset\": %s, \"moviesOrder\": \"POSITION_ASC\", \"supportedItemTypes\": [\"COMING_SOON_MOVIE_LIST_ITEM\", \"MOVIE_LIST_ITEM\", \"TOP_MOVIE_LIST_ITEM\", \"POPULAR_MOVIE_LIST_ITEM\", \"MOST_PROFITABLE_MOVIE_LIST_ITEM\", \"MOST_EXPENSIVE_MOVIE_LIST_ITEM\", \"BOX_OFFICE_MOVIE_LIST_ITEM\", \"OFFLINE_AUDIENCE_MOVIE_LIST_ITEM\", \"RECOMMENDATION_MOVIE_LIST_ITEM\"]}", category.graphName,offset),
